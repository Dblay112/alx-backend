...
const port = 1245;
const initialSeatsCount = seatCount;
...
async function resetAvailableSeats(seatCount) {
  await setAsync('available_seats', Number.parseInt(seatCount, 10));
}
...
app.listen(port, async () => {
  await resetAvailableSeats(initialSeatsCount);
